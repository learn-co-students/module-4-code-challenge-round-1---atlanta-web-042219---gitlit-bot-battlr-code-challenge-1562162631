...
Work on fetching data from this https://github.com/ac2cic/module-4-code-challenge-round-1---atlanta-web-042219---gitlit-bot-battlr-code-challenge-1562162631.git. The response should contain an array of bot objects that are structured as follows:
...
_Note that nothing needs to be persisted. Refreshing the page should clear out the current army._ -->j
